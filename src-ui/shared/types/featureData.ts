...
export const FAQ_DATA = [
  // PAYMENTS & BILLING
  {
    ...
    question: "Why does my bank statement show \"Paddle.com\" instead of Explified or RemoveBG?",
    answer: "Paddle is our payment processor and handles all transactions on our behalf. When you subscribe to RemoveBG, the charge on your bank statement will appear as \"Paddle.com\" or \"Paddle.NET\" — this is completely normal and confirms your payment was processed successfully. For any questions, contact us at support@explified.com and we'll help you directly."
  },
  {
    category: "Payments & Billing",
