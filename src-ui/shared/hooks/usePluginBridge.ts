...
export function usePluginBridge() {
  ...
  const applyAdjustments = useCallback((brightness: number, contrast: number, saturation: number, opacity?: number, backgroundPreset?: string, imageFilterPreset?: string) =>
